...
module.exports = function handler(req, res) {
  ...
  const seed = [
    ...
    },
    {
      ...
      internalRequired: false,
      sections: ["Greeting","Opener","Solution","Closer","Sign-Off"],
      requirements: "Personalized response including information from the FAQ Rithmic & Ninja Connection Guide and corresponding link: https://support.apextraderfunding.com/hc/en-us/articles/31519440985499-Rithmic-Ninja-Connection-Gui…",
      category: "Support",
      intent: "",
    ...
    },
    {
      ...
      internalRequired: false,
      sections: ["Greeting","Opener","Solution","Closer","Sign-Off"],
      requirements: "Personalized response explaining that the user should activate the TradingView plugin. The message should include the explanation on how to activate the plugin (or addon) from Tradovate and/or some wording from the following FAQ and the link to it: https://support.apextraderfunding.com/hc/en-us/articles/31519470769947-Tradovate-Setup-TradingView.",
      category: "Support",
      intent: "Tradovate data",
      accountId: "APEX-000111",
      tags: ["tradovate_questions"],
      scenario: "You go to NTDash and ensure that the accounts are not blown, membership is ok, but TradingView is not appearing in their plugins.",
      body: "Hello Apex. It's been 2 days and I still can't log in to TradingView. I haven't failed the test, my account is almost at the original balance. Fix my issue!!!",
      attachments: []
    }
  ];
